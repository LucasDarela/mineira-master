...
export function AgendaRow({
  ...
  return (
    <tr
      ...
      className={`border-b border-gray-100 hover:bg-[#e6f2ff] transition-colors cursor-pointer ${
        isNextGame
      ...
      <td className="py-4 px-6">
        <div className="flex flex-col gap-1">
          ...
          {isFinished ? (
            ...
            <span className="text-[10px] text-yellow-600 uppercase tracking-widest font-bold flex items-center gap-1.5">
